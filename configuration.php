...
class JConfig {
    ...
    public $user = 'joomla_user';                       // DB username
    public $password = 'kG3Tj6yMeO';                   // DB password
    public $db = 'joomla';                         // DB database name
    public $dbprefix = 'kpz_';               // Do not change unless you need to!

    /* Server Settings */
    public $secret = 'wKyGY2t8fa96KaxVR0Q4nTfKoFgdg7iS';     // Change this to something more secure
    public $gzip = '0';
    ...
    public $log_path = '/var/log/joomla';           // Please check with your host that this is the correct path to the logs directory. This path needs to be writable by Joomla!
